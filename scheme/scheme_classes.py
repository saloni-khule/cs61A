...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        elif self.bindings.get(symbol)==None and self.parent!=None :
    ...
    def make_child_frame(self, formals, vals):
        ...
        # BEGIN PROBLEM 8
        new=Frame(self)
        # new.define(formals,vals)
        # def helper(formals,vals):
        #     if formals.rest==nil:
        #         return new.define(formals.first,vals.first)
        #     else:
        #         return helper(formals.rest,vals.rest)
