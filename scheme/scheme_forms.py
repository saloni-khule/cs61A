...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # back = LambdaProcedure(formals,body,env)
        # env.define(symbol,back)
...
def do_and_form(expressions, env):
    ...
    while expressions!=nil:
        ...
        check = scheme_eval(expressions.first,env,tail)
        if is_scheme_false(check):
            return check
        else:
